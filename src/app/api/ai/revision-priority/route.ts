...
export async function POST(request: Request) {
  try {
    ...
    const currentUser = user as unknown as IUser & { targetCompany?: string };
    const targetCompany = String((body.targetCompany as string) ?? currentUser.targetCompany ?? "Not set");
